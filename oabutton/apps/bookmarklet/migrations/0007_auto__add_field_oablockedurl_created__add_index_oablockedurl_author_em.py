...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OABlockedURL.created'
        db.add_column(u'bookmarklet_oablockedurl', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding index on 'OABlockedURL', fields ['author_email']
        db.create_index(u'bookmarklet_oablockedurl', ['author_email'])


    def backwards(self, orm):
        # Removing index on 'OABlockedURL', fields ['author_email']
        db.delete_index(u'bookmarklet_oablockedurl', ['author_email'])

        # Deleting field 'OABlockedURL.created'
        db.delete_column(u'bookmarklet_oablockedurl', 'created')
