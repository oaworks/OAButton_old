...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OAUser.email_confirmed'
        db.add_column(u'bookmarklet_oauser', 'email_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OAUser.confirm_expiration'
        db.add_column(u'bookmarklet_oauser', 'confirm_expiration',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OAUser.email_confirmed'
        db.delete_column(u'bookmarklet_oauser', 'email_confirmed')

        # Deleting field 'OAUser.confirm_expiration'
        db.delete_column(u'bookmarklet_oauser', 'confirm_expiration')
    ...
    models = {
        ...
        u'bookmarklet.oauser': {
            ...
            'confirm_expiration': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
