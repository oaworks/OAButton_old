...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OAEvent.url'
        db.alter_column(u'bookmarklet_oaevent', 'url', self.gf('django.db.models.fields.URLField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'OAEvent.url'
        db.alter_column(u'bookmarklet_oaevent', 'url', self.gf('django.db.models.fields.URLField')(max_length=400))
